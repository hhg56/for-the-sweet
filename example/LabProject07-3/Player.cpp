...
CAirplanePlayer::CAirplanePlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	...
	CMesh *pAirplaneMesh = new CMesh(pd3dDevice, pd3dCommandList, "FlyerPlayership.txt");
#else
	CMesh *pAirplaneMesh = new CMesh(pd3dDevice, pd3dCommandList, "FlyerPlayership.bin");
#endif
