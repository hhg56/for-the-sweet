...
void CGameFramework::ProcessInput()
{
	...
	{
		if (pKeysBuffer['W'] & 0xF0) dwDirection |= DIR_FORWARD;		// VK_UP
		if (pKeysBuffer['S'] & 0xF0) dwDirection |= DIR_BACKWARD;	// VK_DOWN
		if (pKeysBuffer['A'] & 0xF0) dwDirection |= DIR_LEFT;		// VK_LEFT
		if (pKeysBuffer['D'] & 0xF0) dwDirection |= DIR_RIGHT;		// VK_RIGHT
		if (pKeysBuffer['Q'] & 0xF0) dwDirection |= DIR_UP;		// VK_PRIOR
		if (pKeysBuffer['E'] & 0xF0) dwDirection |= DIR_DOWN;		// VK_NEXT
	}
