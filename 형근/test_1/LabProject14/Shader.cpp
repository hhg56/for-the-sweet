		...
		for (int z = 0; z < zObjects; z++)
		{
			for (int y = 0; y < yObjects; y++)
			{
				...
				if (y == 0)
				{
					...
					XMFLOAT3 rotate_y = XMFLOAT3(0.0f, 1.0f, 0.0f);

					xmf3RotateAxis = Vector3::CrossProduct(rotate_y, xmf3SurfaceNormal);
					if (Vector3::IsZero(xmf3RotateAxis)) xmf3RotateAxis = XMFLOAT3(0.0f, 1.0f, 0.0f);
					float fAngle = acos(Vector3::DotProduct(rotate_y,	xmf3SurfaceNormal));
