...
XMFLOAT4 CHeightMapGridMesh::OnGetColor(int x, int z, void *pContext)
{
	...
	XMFLOAT3 a_1 = pHeightMapImage->GetHeightMapNormal(x, z);
	XMFLOAT3 a_2 = pHeightMapImage->GetHeightMapNormal(x + 1, z);
	XMFLOAT3 a_3 = pHeightMapImage->GetHeightMapNormal(x + 1, z + 1);
	XMFLOAT3 a_4 = pHeightMapImage->GetHeightMapNormal(x, z + 1);

	float fScale = Vector3::DotProduct(a_1, xmf3LightDirection);
	
	fScale += Vector3::DotProduct(a_2, xmf3LightDirection);
	fScale += Vector3::DotProduct(a_3, xmf3LightDirection);
	fScale += Vector3::DotProduct(a_4, xmf3LightDirection);
